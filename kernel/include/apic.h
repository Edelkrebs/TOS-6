...
#define INTERRUPT_SOURCE_OVERRIDE_ACTIVE_LOW (1 << 1)
#define INTERRUPT_SOURCE_OVERRIDE_LEVEL_TRIGGERED (1 << 3)

#define IOAPIC_RED_ENTRY_DEST_MODE (1 << 11)
#define IOAPIC_RED_ENTRY_INTERRUPT_PENDING (1 << 12)
#define IOAPIC_RED_ENTRY_POLARITY (1 << 13)
#define IOAPIC_RED_ENTRY_RECEIVED (1 << 14)
#define IOAPIC_RED_ENTRY_TRIGGER_MODE (1 << 15)
#define IOAPIC_RED_ENTRY_MASK (1 << 16)

#define SVR_EOI_BROADCAST_SUPPRESSION (1 << 12)
#define SVR_FOCUS_PROCESSOR_CHECKING (1 << 9)
